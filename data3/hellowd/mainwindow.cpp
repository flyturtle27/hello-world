...
void MainWindow::on_pushButton_clicked()
{
    ...
    ui->progressBar->setValue(0);
        ...
        for(int i=9000;i<10000;++i)
        {
            ...
            Mat cp1 = img(Rect(0,0,80,80));
            imwrite("ceshi/1.jpg",cp1);

            Mat cp2 = img(Rect(35,0,80,80));
            imwrite("ceshi/2.jpg",cp2);

            Mat cp3 = img(Rect(85,0,80,80));
            imwrite("ceshi/3.jpg",cp3);

            Mat cp4 = img(Rect(120,0,80,80));
            imwrite("ceshi/4.jpg",cp4);

            sprintf(ans,"%04d,%c%c%c%c",i,Test(1),Test(2),Test(3),Test(4));
            fprintf(file,"%s\n",ans);
