...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        lineEdit->setGeometry(QRect(103, 30, 461, 25));
        ...
        lineEdit_2->setGeometry(QRect(103, 70, 461, 25));
        lineEdit_2->setReadOnly(true);
        lineEdit_3 = new QLineEdit(centralWidget);
        lineEdit_3->setObjectName(QStringLiteral("lineEdit_3"));
        lineEdit_3->setGeometry(QRect(103, 110, 461, 25));
        lineEdit_3->setReadOnly(true);
        lineEdit_4 = new QLineEdit(centralWidget);
        lineEdit_4->setObjectName(QStringLiteral("lineEdit_4"));
        lineEdit_4->setGeometry(QRect(103, 150, 461, 25));
        ...
        label_3->setGeometry(QRect(50, 70, 67, 17));
        label_4 = new QLabel(centralWidget);
        label_4->setObjectName(QStringLiteral("label_4"));
        label_4->setGeometry(QRect(50, 110, 67, 17));
        label_5 = new QLabel(centralWidget);
        label_5->setObjectName(QStringLiteral("label_5"));
        label_5->setGeometry(QRect(38, 150, 67, 17));
        lineEdit_5 = new QLineEdit(centralWidget);
        lineEdit_5->setObjectName(QStringLiteral("lineEdit_5"));
        lineEdit_5->setGeometry(QRect(103, 190, 461, 25));
        lineEdit_5->setReadOnly(true);
        label_6 = new QLabel(centralWidget);
        label_6->setObjectName(QStringLiteral("label_6"));
        label_6->setGeometry(QRect(60, 190, 67, 17));
        toolButton = new QToolButton(centralWidget);
        toolButton->setObjectName(QStringLiteral("toolButton"));
        toolButton->setGeometry(QRect(572, 30, 26, 24));
        toolButton_2 = new QToolButton(centralWidget);
        toolButton_2->setObjectName(QStringLiteral("toolButton_2"));
        toolButton_2->setGeometry(QRect(572, 70, 26, 24));
        toolButton_3 = new QToolButton(centralWidget);
        toolButton_3->setObjectName(QStringLiteral("toolButton_3"));
        toolButton_3->setGeometry(QRect(572, 110, 26, 24));
        toolButton_4 = new QToolButton(centralWidget);
        toolButton_4->setObjectName(QStringLiteral("toolButton_4"));
        toolButton_4->setGeometry(QRect(572, 150, 26, 24));
        toolButton_5 = new QToolButton(centralWidget);
        toolButton_5->setObjectName(QStringLiteral("toolButton_5"));
        toolButton_5->setGeometry(QRect(572, 190, 26, 24));
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        lineEdit_2->setText(QApplication::translate("MainWindow", "./deploy.prototxt", Q_NULLPTR));
        lineEdit_3->setText(QApplication::translate("MainWindow", "./lenet_iter_10000.caffemodel", Q_NULLPTR));
